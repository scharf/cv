...
* developed the "What do I have to know to do the next step?" methodology for better usability (I should write a blog post on this topic...)
...
h2. Since Spring 2013: The Adventures of Web Development for a Very Small Startup-Company

Early 2013 it was time to leave Wind River and to go back to the roots of working on a start-up project. This is a web application with a back-end in python and elastic search (which is java). The front end uses angularjs. This involved a lot of learning new technologies. Because I am currently the main developer on this project, I have to work on all aspects of the project, including UI design, server setup, build process, bug fixing etc. It is a very humbling experience to see all the little details necessary to create a product. I have a much better understanding of the struggle of web developers and I see lots of opportunities how better tooling, libraries and services can can support developers.
...
Ultimately what we do is for our customers and therefore understanding the needs and pains of the customers is key. But often great solutions do not come from customer requests but form individuals and teams with a vision and empathy for the customers. 
